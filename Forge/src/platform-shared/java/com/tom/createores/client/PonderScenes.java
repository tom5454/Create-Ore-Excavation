...
public class PonderScenes {
	...
	public static void oreFinder(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.overlay.showControls(new InputWindowElement(util.vector.topOf(ground), Pointing.DOWN).rightClick()
				.withItem(new ItemStack(Registration.VEIN_FINDER_ITEM.get())), 30);
	...
	public static void drillingMachine(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.overlay.showControls(new InputWindowElement(util.vector.topOf(drill), Pointing.DOWN).rightClick()
				.withItem(new ItemStack(Registration.NORMAL_DRILL_ITEM.get())), 30);
		scene.idle(30);
	...
	public static void sampleDrill(SceneBuilder scene, SceneBuildingUtil util) {
		...
		scene.overlay.showControls(new InputWindowElement(util.vector.topOf(ground.above()), Pointing.DOWN).rightClick(), 30);
		...
		scene.overlay.showControls(new InputWindowElement(util.vector.topOf(ground.above()), Pointing.DOWN).rightClick().withItem(new ItemStack(Registration.VEIN_ATLAS_ITEM.get())), 30);
		scene.idle(60);
