...
public class COERecipes extends RecipeProvider {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		ShapedRecipeBuilder.shaped(CreateOreExcavation.NORMAL_DRILL_ITEM.get())
		.pattern("bi ")
		.pattern("ibi")
		.pattern(" ii")
		...
		ShapedRecipeBuilder.shaped(CreateOreExcavation.DIAMOND_DRILL_ITEM.get())
		.pattern("bi ")
		.pattern("idi")
		.pattern(" ii")
		.define('b', Tags.Items.STORAGE_BLOCKS_DIAMOND)
		.define('i', Tags.Items.GEMS_DIAMOND)
		.define('d', CreateOreExcavation.NORMAL_DRILL_ITEM.get())
		.group("create")
		...
		netheriteSmithingM(consumer, CreateOreExcavation.DIAMOND_DRILL_ITEM.get(), CreateOreExcavation.NETHERITE_DRILL_ITEM.get());

		ShapedRecipeBuilder.shaped(CreateOreExcavation.VEIN_FINDER_ITEM.get())
		.pattern("ea ")
		.pattern("rs ")
		.pattern("  s")
		...
		processing("redstone_milling", AllRecipeTypes.MILLING, consumer, b -> b.withItemIngredients(Ingredient.of(CreateOreExcavation.RAW_REDSTONE.get())).output(new ItemStack(Items.REDSTONE, 3)).duration(250));
		processing("redstone_crushing", AllRecipeTypes.CRUSHING, consumer, b -> b.withItemIngredients(Ingredient.of(CreateOreExcavation.RAW_REDSTONE.get())).output(new ItemStack(Items.REDSTONE, 4)).duration(250));

		processing("diamond_cutting", AllRecipeTypes.CUTTING, consumer, b -> b.withItemIngredients(Ingredient.of(CreateOreExcavation.RAW_DIAMOND.get())).output(Items.DIAMOND).duration(250));
		processing("emerald_cutting", AllRecipeTypes.CUTTING, consumer, b -> b.withItemIngredients(Ingredient.of(CreateOreExcavation.RAW_EMERALD.get())).output(Items.EMERALD).duration(250));
	}
